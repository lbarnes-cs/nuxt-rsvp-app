    ...
    <v-form v-model="isValid" @submit.prevent="handleSubmit">
      <v-card class="pa-2">
        ...
        <v-container fluid>
          ...
          <v-row v-if="invite?.guests">
            ...
            >
              ...
              >
                ...
                <v-card
                  variant="outlined"
                  :class="{ ' overflow-visible': isDraggable }"
                >
          ...
          <v-row justify="end">
            <v-col cols="auto">
              <v-btn @click="addGuest" color="secondary">
                <v-icon class="mr-2">mdi-plus</v-icon> Add guest</v-btn
              >
            </v-col>
          </v-row>
          <v-row>
        ...
        <v-card-actions>
          <v-btn :disabled="isSubmitting" color="red" @click="closeDialog"
            >Cancel</v-btn
          >
          <v-spacer></v-spacer>
...
const handleSubmit = async () => {
  ...
  console.log("handle submit", invite.value?.guests?.length);
